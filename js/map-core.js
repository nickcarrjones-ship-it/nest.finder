...
// Smaller bubbles read much better, especially on mobile, and let more of the
// map show at once without the dots merging into a blob.
function getRadiusForZoom(z) {
  return 220 * Math.pow(2, 11 - z);
}
