...
## What's working (as of 2026-04-01)
- Commute overlap algorithm — solid, accurate
- Firebase auth (Google sign-in) + ratings/veto sync
...
- Nest Agent tab — multi-turn chat, suggestion dropdown on focus
- Initial classification runs on every search (after Firebase auth resolves)
- Veto system — vetoed areas removed from map entirely, count shown in header

---

## Current priorities / next session
- Couple account linking (partner 6-char code, coupleId in Firebase)
- Property tracking tab: status workflow, map pins, Firebase storage
- Speech-to-text notes with AI summarisation
- Viewing calendar
